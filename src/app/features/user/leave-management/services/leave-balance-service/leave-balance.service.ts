...
export class LeaveBalanceService {
  ...
  getLeaveBalanceDetails(leaveAvailable: DocumentData): LeaveBalanceDetails {
    const leaveAvailableDetails: LeaveBalanceDetails = {
      ...
      sickLeaveTotal: leaveAvailable?.[LEAVE_BALANCE_DETAILS.SICK_LEAVE_TOTAL],
      specialLeaveTaken:
        leaveAvailable?.[LEAVE_BALANCE_DETAILS.SPECIAL_LEAVE_TAKEN],
    };
    return leaveAvailableDetails;
  }
}
